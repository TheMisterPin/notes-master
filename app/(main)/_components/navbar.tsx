...
function Navbar(props: NavbarProps) {
  ...
  if (document === undefined) {
    return (
      <nav className='bg-background dark:bg-[#1f1f1f] px-3 py-2 w-full h-full flex item center gap-x-4 justify-between'>
        <Title.Skeleton />
  ...
  return (
    <>
      <nav className='bg-background dark:bg-[#1f1f1f] px-3 py-2 w-full  flex item center gap-x-4'>
